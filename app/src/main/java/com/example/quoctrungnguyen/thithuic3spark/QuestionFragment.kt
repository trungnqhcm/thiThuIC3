...
import com.example.quoctrungnguyen.thithuic3spark.Interface.IAnswerSelected
...
class QuestionFragment : Fragment(), IAnswerSelected {
            ...
            if (question != null) {
                if (!TextUtils.isEmpty(result )) {
                    if (result.toString() == question!!.correctAnswer)
                        currentQuestion.type = Common.ANSWER_TYPE.RIGH_ANSWER
                    else
                        currentQuestion.type = Common.ANSWER_TYPE.WRONG_ANSER
              } else
    ...
    lateinit var process_bar: ProgressBar
    ...
    override fun onCreateView(
        ...
        if (question != null) {
            process_bar = itemView.findViewById(R.id.progress_bar) as ProgressBar
...
//                        img_question.setImageResource(R.drawable.ic_error_black_24dp)
//                    }
//
//                })
